...
#define					hDeviceSerialNumberOffset									0			  	  //4
#define					hEthMacAddressOffset										4			  	  //4
#define					hParentSerialNumberOffset									8			  	  //4
#define					hExtraNumberOffset											12			  	  //4
...
#define					hGitCommitBase												(TWO_REGISTER_BASE+100)
...
#define 				hU_Gen_Max													(TWO_REGISTER_BASE_FLOAT+16)//			2
#define					hReferenceR													(TWO_REGISTER_BASE_FLOAT+18)//			2
#define					hADC_reference												(TWO_REGISTER_BASE_FLOAT+20)//			2
...
#define 				hPllClkRatioAD9958											(ONE_REGISTER_BASE+6)			//		1
#define 				hAdcBitRate													(ONE_REGISTER_BASE+7)			//		1
...
#define					hDeviceSerialNumber											(FOUR_REGISTER_BASE+0)			  	  //4
#define					hEthMacAddress												(FOUR_REGISTER_BASE+4)			  	  //4
#define					hSensorSerialNumber											(FOUR_REGISTER_BASE+8)			  	  //4

// setup coefs
#define					hCastCoefBase												(FOUR_REGISTER_BASE+32)		 		 //2*8
